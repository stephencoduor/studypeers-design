...
class Studyset extends CI_Controller {
    ...
    public function details($study_set_id,$reType = null,$tabType = null,$isComment = null)
    {
        $user_id = $this->session->get_userdata()['user_data']['user_id'];
		...
		$tabreType = ($tabType) ? $tabType : ''; 
		$data['tabreType'] = $tabreType;
		
		$openComment = ($isComment) ? $isComment : ''; 
                        ...
                        <div class="chatMsgBox">
                            ...
                            <div class="right">
                                <div class="userWrapText">
                                    <figcaption>
                                        <span class="name"> <a>'.$user_info['nickname'].'</a></span>
                                        '.$comment.'
    ...
    public function postReply(){
        if($this->input->post()){
            ...
            $html = '<div class="userReplyBox" id="comment_reply_id_'.$comment_id.'">
                    <figure>
                        <img src="'.userImage($user_id).'" alt="User">
                    </figure>
                    <div class="right">
    ...
    function rateStudyset(){
        if($this->input->post()){
            ...
            if(!empty($chk_if_rated)) {
                ...
                $this->db->where('study_set_id',$rate_studyset);

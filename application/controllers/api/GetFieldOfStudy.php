...
//API GetFieldOfStudy Controller
class GetFieldOfStudy extends CI_Controller {
  public function __construct()
    ...
    public function index()
    {
       ...
       // check for header 
        $getData = $this->db->query("SELECT * FROM `field_of_study_master` WHERE status = 1")->result_array();

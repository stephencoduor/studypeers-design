...
class Mypagination extends CI_Pagination {
	...
	public function create_links()
	{
		...
		if ($this->prev_link !== FALSE && $this->cur_page !== 1)
		{
			...
			{
				// First page
				$output .= '<div class="prev-arrow"><a href="'.$first_url.'"'.$attributes.$this->_attr_rel('prev').'><img src="'.base_url('assets_d/images/prev.svg').'" alt="Prev Icon"/></a></div>';
			}
			else
			{
				$append = $this->prefix.$i.$this->suffix;
				$output .= '<div class="prev-arrow"><a href="'.$base_url.$append.'"'.$attributes.$this->_attr_rel('prev').'><img src="'.base_url('assets_d/images/prev.svg').'" alt="Prev Icon"/></a></div>';
			}
		...
		if ($this->next_link !== FALSE && $this->cur_page < $num_pages)
		{
			...
			$output .= '<div class="next-arrow"><a href="'.$base_url.$this->prefix.$i.$this->suffix.'"'.$attributes
				.$this->_attr_rel('next').'><img src="'.base_url('assets_d/images/prev.svg').'" alt="Prev Icon"/></a></div>';
		}

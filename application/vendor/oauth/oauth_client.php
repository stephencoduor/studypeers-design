...
*/
	Function Initialize()
	{
		...
		switch($this->server)
		{
			...
			case 'LinkedIn':
				$this->oauth_version = '2.0a';
				$this->request_token_url = 'https://www.linkedin.com/oauth/v2/requestToken?scope={SCOPE}';
				$this->dialog_url = 'https://www.linkedin.com/oauth/v2/authorization?response_type=code&client_id={CLIENT_ID}&redirect_uri={REDIRECT_URI}&state={STATE}&scope={SCOPE}';

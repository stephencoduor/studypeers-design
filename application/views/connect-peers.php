<div class="banner connect-with-peers">
			<div class="container">
				<div class="banner-text">
					<div class="tough-wrap">
						<h4>Connect with your peers</h4>
						<p class="text-center">Join StudyPeers to meet students on campus or around the worls!</p>
					</div>
			...
			<div class="container">
				...
				<div class="stay-connected">
					...
					<div class="top-border">
						<figure>
							<img src="<?php echo base_url(); ?>assets_home/images/student-img.png" alt="Image">
						</figure>
					</div>

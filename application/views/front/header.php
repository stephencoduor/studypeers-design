            ...
            <aside class="">
                <section class="sidebar-content">
                    <section class="sidebar-menu">
                        <ul>
                            <li><a href="index-dashboard-new.html">
                                    <div class="activeBg">
                        ...
                        <div class="buttonGroup">
                            ...
                            <div class="sortwrapper">
                                ...
                                <ul class = "dropdown-menu sort">
                                    ...
                                    <li><a href = "javascript:void(0);">Unanswerd</a></li>
                                    <li><a href = "javascript:void(0);">Unsolved</a></li>
                                </ul>
                            </div>
                    ...
                    <div class="filterForm">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <select class="institutions form-control" name="states[]" multiple="multiple">
                            ...
                            <div class="col-md-12 courseSelect">
                                <label>Course</label>
                                <select class="course form-control" name="states[]" multiple="multiple">
                                    <option value="AL">Alabama</option>
                                    <option value="WY">Wyoming</option>
                                </select>
                            </div>
                            <div class="col-md-12 professorSelect">
                                ...
                                <select class="professor form-control" name="states[]" multiple="multiple">
                                    <option value="AL">Alabama</option>
                                    <option value="WY">Wyoming</option>
                                </select>
                            </div>
                            <div class="col-md-12">
                                <div class="buttonWrapper">
                                    ...
                                    <button type="reset" class="btn-all">Clear</button>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="feed-card list">
                                <div class="right">
                                    <div class="feed_card_inner">
                                        ...
                                        <h5><a href="">Is this a test question?</a></h5>
                                        <div class="badgeList">
                                            <ul>
                            ...
                            <div class="feed-card list">
                                <div class="right">
                                    <div class="feed_card_inner">
                                        ...
                                        <h5><a href="">MS-Is this a test question?</a></h5>
                                        <div class="badgeList">
                                            <ul>
                                                <li class="badge badge1">
                                                    Harvard Law School

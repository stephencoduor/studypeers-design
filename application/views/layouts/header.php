...
<head>
    ...
    <title> StudyPears | <?=ucfirst($page_name)?></title>

    <!-- Bootstrap -->
    <link href="<?=base_url('assets/css/bootstrap.min.css')?>" rel="stylesheet">
    <link rel="stylesheet" href="<?=base_url('front/css/style.css')?>">
    <link rel="stylesheet" type="text/css" href="<?=base_url('front/css/study-set.css')?>">
    <link rel="stylesheet" type="text/css" href="<?=base_url('front/css/custom.css')?>">
...
<body>
    <header>
        <section class="container-fluid">
            <section class="row">
                <section class="col-sm-2 login-logo no-padding">
                    <section class="logo">
                        <a href="<?= base_url() ?>">
                ...
                <section class="col-sm-10 no-padding">
                    <div class="row vertical-center">
                        ...
                        <div class="col-sm-4">
                            <div class="btn-group">
                                <a  href="<?=base_url('home/login')?>" class="transparentBtn" >SIGN IN</a>

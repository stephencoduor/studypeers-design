<div class="social-tools bottom-space">
	<div class="container">
		<div class="cms-content">	  
            ...
            <p class="para">
                    Welcome to the web site (studypeers.dev, the “Site”) and Services (as defined below) of _________. (“studypeers”, “we”, “us” and/or “our”). Studypeers is dedicated to helping people around the world practice and master whatever they are learning. This platform have been created to provide information about our company and its web platform and mobile application services for education institutions (such education institutions, our “Client(s”) (such services, together with the Site, the “Service(s)”) to our users (“you”, “your”, “users”, “Client”). When you share information with us we can help you achieve that goal by helping you find the right content and making your studying quicker and more effective. 
                    This Privacy Notice is meant to help you understand how we collect and use the personal information you provide on our website, and the two official Studypeer iOS and Android mobile applications. 
            </p>					   
            <p class="para">This Privacy Notice is meant to help you understand how we collect and use the personal information you provide on our website, and the two official Studypeer iOS and Android mobile applications. </p>
            <ol class="order-list">
            ...
            <p class="para">a)	Registration directly on Studypeer</p>
            ...
            <p class="para">As part of the registration, users are asked to provide some personal information. Studypeer stores the following user data which are entered during the registration process</p>
            <ul class="unordered-list">
            ...
            <p class="para">Studypeer, like many businesses, sometimes hires other companies to perform certain business related functions. Examples of such functions include an email service provider that sends out mailing information on our behalf and a hosting provider for maintaining our databases. When we employ another company to perform a function of this nature, we only provide them with the information that they need to perform their specific function.</p>
            <p class="para"><strong>Legal Requirements:</strong></p>
            <p class="para">Studypeer may disclose your Personal Data if required to do so by law or in the good faith belief that such action is necessary to:</p>
            <ul class="unordered-list">
                <li>•	comply with a legal obligation.</li>
                <li>•	protect and defend the rights or property of Studypeer inc.</li>

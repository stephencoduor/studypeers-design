				...
				<section class="mainContent noPadding">
					...
					<div class="mainCardWrapper">
						<div class="commoncard" id="learnboxes">
								...
								<div class="learnbox-answer">
									<div class="form-group">
											<label class="custom-radio">
												<input type="radio" name="answer[74]" value="" required="">
												<span class="checkmark" style="font-size: 35px;"></span> You are training a new dynamics 365 Finance developer. You need to explain the relatclaionships between models, packages, and projects to the new hire. Which three design concepts should you explain? Each correct answer presents a complete solution.		
											</label>
										</div>
								</div>

...
<head>
	...
	<!-- <link rel="stylesheet" type="text/css" href="css/study-set.css"> -->
					...
					<section class="sidebar-content">
						<section class="sidebar-menu">
		                	<ul>
		                		...
		                		<li><a href="javascript:void(0);">
	                				...
	                				Articles </a></li>
		                		<li class="active"><a href="qa.html">
	                				<div class="activeBg">
	                					<svg class="sp-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
		                ...
		                <section class="coursepanel">
		                	...
		                	<section class="courseheader">
		                		<h6>Anthropological Theory</h6>
		                		<a class="bullet">1</a>
		                	</section>
		                	<section class="courseheader">
		                		<p>What Kind of Lawyer Do You WanWhat Kind of Lawyer Do You WanWhat Kind of Lawyer Do You Wan</p>
		                	</section>
		                	<section class="courseheader">
					...
					<div class="studySetWrapper list qa-detail">
						<div class="header">
							...
							<div class="studybuttonGroup">
								...
								<button type="button" class="transparentBtn" onclick="location.href='question-qa.html';">
									<svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" 
						...
						<div class="voteHeaderWrapper">
							<div class="voteCount">
								<div class="uparrow">
									<svg xmlns="http://www.w3.org/2000/svg"  class="normalState" width="18.363" height="20" viewBox="0 0 18.363 20">
								...
								<div class="downarrow">
									<svg xmlns="http://www.w3.org/2000/svg" width="18.363" height="20" class="normalState" viewBox="0 0 18.363 20">
							...
							<div class="rightHdrWrapper">
								<h4>If a cat meows but none’s around to hear it, does it make a sound?</h4>
								<div class="badgeList">
									<ul>
						...
						<div class="detailDescription">
							<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Maecenas ultricies mi eget mauris pharetra et ultrices. Eu volutpat odio facilisis mauris sit amet massa vitae tortor. Convallis a cras semper auctor. Morbi non arcu risus quis varius quam. Adipiscing elit duis tristique sollicitudin nibh sit amet commodo nulla. Potenti nullam ac tortor vitae purus faucibus ornare suspendisse. Tortor at auctor urna nunc id cursus. Sollicitudin aliquam ultrices sagittis orci a scelerisque purus. Mauris pharetra et ultrices neque ornare aenean euismod elementum nisi. Integer malesuada nunc vel risus commodo. Adipiscing bibendum est ultricies integer quis auctor. Diam quis enim lobortis scelerisque fermentum dui faucibus. Cras adipiscing enim eu turpis egestas pretium. Id aliquet lectus proin nibh nisl condimentum id venenatis. Sed sed risus pretium quam.</p>
							<p>Molestie a iaculis at erat pellentesque adipiscing commodo elit at. Pulvinar etiam non quam lacus suspendisse. Arcu odio ut sem nulla pharetra diam sit amet nisl. Diam vulputate ut pharetra sit amet. Ullamcorper velit sed ullamcorper morbi. Dolor magna eget est lorem ipsum. A diam maecenas sed enim ut sem. Tellus molestie nunc non blandit massa enim nec. Id semper risus in hendrerit gravida. Mollis aliquam ut porttitor leo a diam sollicitudin. Mi quis hendrerit dolor magna eget est lorem ipsum dolor. Volutpat sed cras ornare arcu dui vivamus.</p>
						</div>
						...
						<div class="commentAnswer">
							<div class="form-group comment">
								<textarea name="" id="definition0" cols="30" rows="10"></textarea>
							</div>
							<a class="filterBtn"> 
								Submit
							</a>
						...
						<div class="commentfilterWrapper">
							...
							<div class="filterSelect">
								<select class="form-control" placeholder="Votes">
								  <option>Votes</option>
								  <option value="AL">Vote1</option>
								  <option value="WY">Vote2</option>
								</select>
							</div>
						</div>
								...
								<div class="feed-card list">
									<div class="right">
										<div class="feed_card_inner">
											<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Maecenas ultricies mi eget mauris pharetra et ultrices. Eu volutpat odio facilisis mauris sit amet massa vitae tortor. </p>
										</div>
						...
						<div class="innerreplyAndComment">
					...
					<div class="row">
						<div class="col-md-12">
							<div class="form-group button">
								<button type="submit" class="transparentBtn highlight">No</button>

				...
				<section class="mainContent">
					<div class="studySetWrapper list">
							...
							<div class="row">
								<div class="col-md-12">
									<div class="form-group">
										<!-- <label>Name</label> -->
										<input type="text" name="" class="form-control form-control--lg" placeholder="Title...">
									</div>
								</div>
							</div>
							<div class="row">
						...
						<div class="studybuttonGroup">
							<button type="button" class="transparentBtn" onclick="location.href='qa.html';">Cancel</button>

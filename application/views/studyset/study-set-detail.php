...
<section class="mainContent">
		<?php	
			if(!empty($tabreType)){
		?>
		<a class="backBtn" href="javascript:;" onclick="window.location.href='<?php echo base_url('account/searchResult/'.$tabreType); ?>'">
												...
												<td data-th="User"><span class="bt-content">
																			<div class="sp-avatar sp-avatar--small">
																				...
																				<div class="sp-avatar__content">
																					<span class="sp-avatar__name"><a href="<?php echo userProfileLink($value['userId']); ?>"><?= $value['nickname']; ?></a></span>
																				</div>
																			</div>
																		</span></td>
												<td data-th="Score"><span class="bt-content"><?= $value['correct']; ?> / <?= $value['total']; ?></span></td>
							...
							<?php foreach ($comment as $key => $value) {
								...
								<div class="chatMsg" id="comment_id_<?= $value['id']; ?>">
									...
									<div class="right">
										...
										<figcaption>
											<span class="name"> <a href="<?php echo userProfileLink($value['user_id']) ?>"><?php echo $user_info['nickname'] ?></a></span>
											<?php if($value['type'] == 1) { ?>
											...
											?>
												<div class="userReplyBox" id="comment_reply_id_<?= $value2['id']; ?>">
													...
													<div class="right">
														<div class="userWrapText">
														<figcaption>
															<span class="name"><a href="<?php echo userProfileLink($value2['user_id']) ?>"><?= $user_info2['nickname'] ?></a></span>

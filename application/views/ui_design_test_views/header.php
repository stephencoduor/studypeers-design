...
<head>
    ...
    <!-- Emoji Css -->
    <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>assets_a/css/jquery.emojipicker.css">
    <!-- Emoji Data -->
    <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>assets_a/css/jquery.emojipicker.tw.css">
    <!-- Starr Rating -->
                    ...
                    <div class = "collapse navbar-collapse" id = "example-navbar-collapse">
                        <ul class = "nav navbar-nav pull-right">
                            ...
                            <li class = "dropdown">
                                <a href = "#" class = "dropdown-toggle" data-toggle = "dropdown">
                                    <img src="<?php echo base_url(); ?>assets_a/images/user1.jpg" alt="User" >
                                    <div class="dropIcon">
                        ...
                        <div class="search">
                            <div class="searchIcon">
                                <img src="<?php echo base_url(); ?>assets_a/images/search.png" alt="search">
                            </div>
                            <input type="text" name="">
                            <div class="removeSearch">
                                <img src="<?php echo base_url(); ?>assets_a/images/close.svg" alt="close" >
                            </div>
                        </div>
                    </div>
                </nav>

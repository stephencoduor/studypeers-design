						...
						<div class="subheader_top">
							<div class="main_subheaderLeft">
								<?php
									if($tabType != ''){
								?>
								<a href="javascript:;" onclick="window.location.href='<?php echo base_url('account/searchResult/'.$tabType); ?>'">
							...
							<div class="main_subheaderRight">
								...
								?>
								&nbsp;
								<a type="button" href="javascript:;" class="transAction reportThings" data-reportType="DOCUMENTS" data-currentPage="documentDetail" data-primaryId="<?php echo $result['id']; ?>">

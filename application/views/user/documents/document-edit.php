<section class="mainContent">
					<div class="studySetWrapper list">
						...
						<form method="post" action="<?php echo base_url(); ?>account/editDocument/<?php echo base64_encode($result['id']); ?>" enctype="multipart/form-data" onsubmit="return validateDocument()">	
							<div class="content-box">
								<div class="row">
									<div class="col-md-12">
										<div class="form-group">
											<!-- <label>Name</label> -->
											<input type="text" name="document_name" id="document_name" class="form-control form-control--lg" placeholder="Name" value="<?= $result['document_name']; ?>">
											<span class="custom_err" id="err_document_name"></span>
										</div>
									</div>
									<div class="col-md-12">
										<div class="form-group">
											<textarea name="description" placeholder="Description" id="description" class="textarea-gray"><?= $result['description']; ?></textarea>
									...
									<div class="col-md-12">
										<div class="form-row">
											...
											<div class="col-sm-6">
												<?php   $userfile_name = $result['featured_image'];
														$extn = substr($userfile_name, strrpos($userfile_name, '.')+1); 
														if($extn == 'docx' || $extn == 'doc') { 
															$urlI = base_url().'assets/images/doc.png';
															
														} else if($extn == 'pdf') { 
															$urlI = base_url().'assets/images/pdf.jpg';
															
														} else if($extn == 'ppt' || $extn == 'pptx') { 
															$urlI = base_url().'assets/images/ppt.png';
												...
												<labe class="imageBoxUpload">
													...
													<input type="hidden" name="featured_image_old" value="<?= $result['featured_image']; ?>">
												</labe>

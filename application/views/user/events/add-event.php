<section class="mainContent">
					<div class="studySetWrapper list">
						...
						<form method="post" action="<?php echo base_url(); ?>account/addEvent" enctype="multipart/form-data" onsubmit="return validateEvent()">	
								...
								<div class="row">
									...
									<div class="col-md-12">
										<div class="form-group location" id="location">
											...
											<input type="text" name="location_txt" class="form-control form-control--lg" id="location_txt" onfocus="geolocate()" placeholder="Location">

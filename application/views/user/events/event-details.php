						...
						<div class="scheduleWrapper">
							...
							<div class="col-sm-8">
								...
								<div class="socialEventsDisplayWrapper">
									...
									<div class="userWrap eventBox">
										<div class="edit">
											<a href="<?php echo base_url(); ?>account/editEvent/<?php echo base64_encode($event['id']); ?>">
									...
									<div class="action">
										...
										<a href="#" class="addEvents delete_event" data-id="<?= $event['id']; ?>" data-toggle="modal" data-target="#addEventModal">
							...
							<div class="col-sm-12">
								...
								<div class="comment-title">
									...
									Comments (<?php echo count($comment); ?>)	
								</div>

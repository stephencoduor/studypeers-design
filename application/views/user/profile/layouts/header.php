...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>assets_d/css/fm.selectator.jquery.css">
                        ...
                        <ul class = "nav navbar-nav pull-right">
                            ...
                            <li class="message dropdown">
                                ...
                                <ul class = "dropdown-menu">
                                    ...
                                    <li><a href = "javascript:void(0);">Message 2</a></li>
                                    <li><a href = "javascript:void(0);">Message 3</a></li>
                                    <li class = "divider"></li>
                                    <li><a href = "javascript:void(0);">Message 4</a></li>
                                </ul>
                            </li>
                            <li class="user">
                                <?php
            ...
            <aside>
                <section class="sidebar-content">
                    <section class="sidebar-menu">
                        <ul>
                            <li class="<?php if($index_menu == 'dashboard') { echo 'active'; } ?>"><a href="<?php echo base_url(); ?>account/dashboard">
                                    <div class="activeBg">
                                    ...
                                    Home</a></li>
                            <li class="<?php if($index_menu == 'schedule') { echo 'active'; } ?>"><a href="<?php echo base_url(); ?>account/schedule">
                                    <div class="activeBg">
                                    ...
                                    Schedule </a></li>
                            <li class="<?php if($index_menu == 'events') { echo 'active'; } ?>"><a href="<?php echo base_url(); ?>account/events">
                                    <div class="activeBg">
                                        <svg class="sp-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 490 490">
                                    ...
                                    Events</a></li>
                            <li class="<?php if($index_menu == 'study-sets') { echo 'active'; } ?>"><a href="<?php echo base_url().'studyset'?>">
                                    <div class="activeBg">
                                    ...
                                    Study Sets</a></li>
                            <li class="<?php if($index_menu == 'documents') { echo 'active'; } ?>"><a href="<?php echo base_url(); ?>account/documents">
                                    <div class="activeBg">
                            ...
                            <li><a href="javascript:void(0);">
                                    ...
                                    Articles </a></li>
                            <li class="<?php if($index_menu == 'questions') { echo 'active'; } ?>"><a href="<?php echo base_url(); ?>account/questions">
                                    <div class="activeBg">
                                        <svg class="sp-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">

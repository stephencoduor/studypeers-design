<div class="modal fade" id="privacyPost" role="dialog">
                        ...
                        <li>
                            <a>
                                <label class="dashRadioWrap">
                                    ...
                                    <input type="radio" class="privacy_val"  name="radio" value="2">
                                    <span class="checkmark"></span>
                                </label>
                            </a>
                        </li>
                        <li>
                            <a>
                                <label class="dashRadioWrap">
                                    ...
                                    <input type="radio" class="privacy_val"  name="radio" value="3">
                                    <span class="checkmark"></span>
                                </label>
                            </a>
                        </li>
                        <li>
                            <a>
                                <label class="dashRadioWrap">
                                    ...
                                    <input type="radio" class="privacy_val"  name="radio" value="4">
                                    <span class="checkmark"></span>
                                </label>
                            </a>
                        </li>

<section class="mainContent">
					<div class="studySetWrapper list">
						...
						<form method="post" action="<?php echo base_url(); ?>account/addQuestion" enctype="multipart/form-data" onsubmit="return validateQuestion()">	
							<div class="content-box">
								<div class="row">
									<div class="col-md-12">
										<div class="form-group">
											<!-- <label>Name</label> -->
											<input type="text" name="question_title" id="question_title" class="form-control form-control--lg" placeholder="Title...">
							...
							<div class="content-area">
								<div class="row">
									<div class="col-md-12">
										...
										<textarea name="textarea" id="jqte-test" class="jqte-test"></textarea>

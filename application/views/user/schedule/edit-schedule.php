<section class="mainContent">
						<div class="scheduleWrapper">
								...
								<form method="post" action="<?php echo base_url(); ?>account/editSchedule/<?php echo base64_encode($schedule['id']) ?>" onsubmit="return validateSchedule()">
											...
											<div id="form-details">
												<div class="col-md-12">
													<div class="form-group">
														<input type="text" name="schedule_name" class="form-control form-control--lg" id="schedule_name" placeholder="Schedule Name" value="<?= $schedule['schedule_name'] ?>">
												...
												<div class="col-md-12">
													<div class="form-group">
														<textarea name="description" placeholder="Description" id="description" class="textarea-gray"><?= $schedule['description'] ?>
														</textarea>
															...
															<div class="form-group calendar">
																...
																<div class="filtercalendar">
																  	<div class="input-group date" id="datetimepickerstart">
													                    ...
													                    <input type="text" class="form-control" name="start-date" id="start-date" value="<?php echo date('m/d/Y h:i A', strtotime($schedule['start_date'])); ?>">
															...
															<div class="form-group calendar">
																...
																<div class="filtercalendar">
																  	<div class="input-group date" id="datetimepickerend">
													                    ...
													                    <input type="text" class="form-control" name="end-date" id="end-date" value="<?php echo date('m/d/Y h:i A', strtotime($schedule['end_date'])); ?>">

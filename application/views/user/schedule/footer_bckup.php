...
<script src='<?php /*echo base_url(); */?>assets_d/js/fullcalendar-1.js'></script>>-->
   ...
   var currMonth = new Date(e.date).getMonth() + 1; alert(currMonth);
 });
  ...
  $('#datetimepickerday').on('dp.change', function(e){ 
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBNNCJ7_zDBYPIly-R1MJcs9zLUBNEM6eU&libraries=&v=weekly"
      defer async ></script> 
</body>
</html>
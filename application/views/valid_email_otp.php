	...
	<?php } ?>
		<div class="col-xl-6 col-lg-6 col-md-8">
			<div class="box_account">
				...
				<form class="" id="verification_form" action="<?php echo site_url('login/register_user'); ?>" method="post">
					<div class="form_container">
						...
						<div class="clearfix add_bottom_15">
							<div class="float-left"><a id="sign_up" href="<?php echo site_url('home/register'); ?>"> <small><?php echo get_phrase("resend_OTP").'?'; ?></small> </a></div>
							<div class="float-right"><a id="login" href="<?php echo site_url('home/login'); ?>"> <small><?php echo get_phrase('back_to_login'); ?>?</small> </a></div>
						</div>
						<div class="text-center"><input type="button" id="verify_email" value="<?php echo get_phrase('Verify Email'); ?>" class="bttn-mid btn-fill change_password"></div>
					</div>
				</form>
			</div>
		</div>

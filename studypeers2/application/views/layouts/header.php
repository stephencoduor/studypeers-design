            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav m-auto">
                        <li class="nav-item">
                            <a class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Study</a>
                            
                        </li>
                        <li class="nav-item"><a class="nav-link" href="services.html">Plan</a></li>
                        <li class="nav-item"><a class="nav-link" href="services.html">Connect</a></li>
                    ...
                    <div class="header-btn justify-content-end">
                        <a href="<?=base_url('home/login')?>" class="bttn-small btn-emt1 ">SIGN IN</a>
                    </div>
                    <div class="header-btn justify-content-end">
                        <a href="<?=base_url('home/register')?>" class="bttn-small btn-emt"><i class="ti-crown"></i>CREATE AN ACCOUNT</a>
                    </div>
                </div>
            </div>
        </nav>
